...
export default function RotationTimelineScreen() {
  ...
  const handleGenerateRotation = () => {
    ...
    Alert.alert('Generate Rotation', 'How would you like to order the payouts?', [
    ...
    <SafeAreaView style={[styles.safeArea, { backgroundColor: theme.background }]}>
      ...
      <View style={styles.header}>
        ...
        <TouchableOpacity
          ...
          onPress={() => router.push('/sub/notification')}
        >
              ...
              return (
                <View key={item.id} style={styles.timelineRow}>
                  <View style={styles.graphicColumn}>
                    ...
                    {!isLast && (
                      <View
                        style={[styles.connectingLine, { backgroundColor: theme.inputBorder }]}
                      />
                    )}
                  </View>
                    ...
                    >
                      ...
                      <Text
                        style={[
                          styles.nameText,
                          { color: textColor },
                          isPast && { textDecorationLine: 'line-through', opacity: 0.6 },
                        ]}
                      >
