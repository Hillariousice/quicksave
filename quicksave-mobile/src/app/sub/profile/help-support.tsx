...
const FAQS = [
  ...
  { id: '2', question: 'Is my money safe?', answer: 'Yes. All funds are secured in the Quicksave Vault technology until the cycle completes.' },
  { id: '3', question: 'How do payouts work?', answer: 'Payouts automatically process to your wallet based on the group rotation schedule.' }
];
    ...
    <SafeAreaView style={[styles.safeArea, { backgroundColor: theme.background }]}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        ...
        <View style={[styles.searchContainer, { backgroundColor: theme.inputBg }]}>
          ...
          <TextInput style={[styles.searchInput, { color: theme.text }]} placeholder="Search for help topics..." placeholderTextColor={theme.textSecondary} />
        </View>
          ...
          {FAQS.map(faq => (
            ...
            >
              <View style={styles.faqRow}>
                ...
                <Feather name={expandedId === faq.id ? "chevron-up" : "chevron-down"} size={20} color={theme.textSecondary} />
              </View>
              {expandedId === faq.id && (
        ...
        {/* CONTACT BOTTOM */}
        <Text style={[styles.sectionTitle, { color: theme.text, marginTop: 32 }]}>Still need help?</Text>
        <TouchableOpacity style={[styles.contactButton, { backgroundColor: theme.primary }]} onPress={() => router.push('/sub/messages/support')}>
...
const styles = StyleSheet.create({
  ...
  searchContainer: { flexDirection: 'row', alignItems: 'center', height: 50, borderRadius: 12, paddingHorizontal: 16, marginBottom: 24, marginTop: 10 },
  ...
  catIconBg: { width: 40, height: 40, borderRadius: 10, justifyContent: 'center', alignItems: 'center', marginBottom: 12 },
  ...
  contactButton: { flexDirection: 'row', height: 56, borderRadius: 28, justifyContent: 'center', alignItems: 'center', gap: 8, marginBottom: 12 },
